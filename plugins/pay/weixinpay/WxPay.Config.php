...
* 
**/
require_once ROOT_PATH."plugins/pay/weixinpay/lib/WxPay.Config.Interface.php";
use think\Db;
/**
*
...
class WxPayConfig extends WxPayConfigInterface
{
	...
	**/
	...
	{
		return $_SERVER["REQUEST_SCHEME"].'://'.$_SERVER['HTTP_HOST'].'/mobile/weixin/jsapi_notify_url';
	}
